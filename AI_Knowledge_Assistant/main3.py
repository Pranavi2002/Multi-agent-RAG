# top-k tuning
# include top_docs for score to ensure RAGAS and DeepEval will work
# since RAGAS, DeepEval work only with OpenAI, 
# for offline metrics change answer to embedder in score

# no reranking and no summarization
...
def main():
    ...
    while True:
        ...
        # score = evaluator.evaluate(query, top_docs, answer)
